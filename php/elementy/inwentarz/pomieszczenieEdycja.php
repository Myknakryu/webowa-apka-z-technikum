...
if (isset($_GET['q'])) {
    ...
    <div class="card">
        ...
        echo "</tr>";
            ...
            <td>" ."<input type='number' id='".$wynik['id']."' value='". $wynik['ilosc'] . "'></td>
                <td>" . $wynik['utworzenie'] . "</td>
            <td>" . $wynik['edycja'] . "</td>";
                  $listaIlosc .= $wynik['ilosc'].",";  
            if($posiadane)
        ...
        echo "<p id='listaWart' style='display:none;'>$listaIlosc</p>";
        ?>
    </div>
    <div class="card-footer">
        ...
        echo "Pomieszczenie należy do: ".$stuff['login'];
         if($posiadane){
            ...
            echo  "<button class='btn btn-secondary float-right' onclick='zapisz( ".$_GET['q'].")'>Zapisz</button>";
