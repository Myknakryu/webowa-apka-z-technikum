...
<input type="submit" value="Zaloguj sie jako gosc!" name="gosc">
</form>
<?php
if ($_SESSION['locked']==1){
    echo '<br>'.'Twoje konto czeka na zaakceptowanie przez administratora lub nie zostało znalezione w bazie danych.';
    $_SESSION['locked']=0;
}
?>
<form method="POST" action="php/rejestr.php">
<input type="submit" value="Zarejestruj sie" name="reje">
</div>
